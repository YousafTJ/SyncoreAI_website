  ...
  return (
    <section id="contact" className="section-padding bg-white">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="glass-card p-8 md:p-12 slide-up hover:shadow-xl transition-all duration-300">
          ...
          <div className="mt-12 pt-8 border-t border-gray-200">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 text-center">
              <div className="space-y-2">
                ...
                <p className="text-gray-600">kontakt@syncoreai.dk</p>
              </div>
              ...
              <div className="space-y-2">
                ...
                <h4 className="font-semibold text-gray-800">Responstid</h4>
                <p className="text-gray-600">Inden for 24 timer</p>
              </div>
              ...
              <div className="space-y-2">
                ...
                <h4 className="font-semibold text-gray-800">Gratis konsultation</h4>
                <p className="text-gray-600">30 min. strategimøde</p>
              </div>
            </div>
          </div>
        </div>
