        ...
        <div className="gradient-primary rounded-3xl p-8 md:p-12 text-center relative overflow-hidden">
          ...
          <div className="relative z-10">
            ...
            <p className="text-xl text-white/90 mb-8 max-w-2xl mx-auto">
              Start din rejse mod fuld automatisering i dag. Book en gratis demo 
              og se hvordan vores AI-agenter kan transformere din forretning.
            </p>
            <button className="bg-white text-gray-900 px-8 py-4 rounded-xl font-semibold text-lg transition-all duration-300 transform hover:scale-105 hover:shadow-lg flex items-center justify-center space-x-2 mx-auto">
              <span>Book Demo Nu</span>
              <ArrowRight size={20} />
            </button>
          </div>
        </div>
